...
FOOT_CONF = os.path.join(DOTFILES_DIR, "foot", "foot.ini")
ROFI_SHARED_PATH = os.path.join(COMPONENTS_DIR, "rofi", "shared.rasi")
EWW_COLORS_PATH = os.path.join(COMPONENTS_DIR, "eww", "styles", "_colors.scss")
...
/* Toolbars, Actionbars & Statusbars */
...
/* Tooltips, Progress & Miscellaneous */
...
/* Libadwaita / Modern GTK semantic colors */
